  ...
  return (
    <div>
      ...
      <div style={{
        ...
        backgroundColor: 'rgba(128,160,192,0.07)',
        borderLeft: `2px solid rgba(74,143,204,0.45)`,
        borderRadius: '0 4px 4px 0',
      }}>
        <p style={{ fontSize: '0.54rem', color: t.muted, lineHeight: 1.6, margin: 0 }}>
          Zones are generated by <b style={{ color: t.lbl }}>k-means clustering of OSM substations</b>,
          weighted by voltage level and nearby population.
          Zone boundaries are <b style={{ color: t.lbl }}>Voronoi polygons</b> clipped to the country border.
